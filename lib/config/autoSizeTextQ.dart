...
class AutoSizeTextQ extends StatefulWidget {
  const AutoSizeTextQ(
      this.data, {
        Key key,
        this.textKey,
  ...
  @override
  _AutoSizeTextQState createState() => _AutoSizeTextQState();
}

class _AutoSizeTextQState extends State<AutoSizeTextQ> {
  @override
  initState() {
    super.initState();
  ...
  @override
  void didUpdateWidget(AutoSizeTextQ oldWidget) {
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(builder: (context, size) {
      ...
      if (style.fontSize == null) {
        style = style.copyWith(fontSize: AutoSizeTextQ._defaultFontSize);
      }
...
class AutoSizeGroup {
  final _listeners = <_AutoSizeTextQState, double>{};
  var _widgetsNotified = false;
  double _fontSize = double.infinity;

  _register(_AutoSizeTextQState text) {
    _listeners[text] = double.infinity;
  }

  _updateFontSize(_AutoSizeTextQState text, double maxFontSize) {
  ...
  _remove(_AutoSizeTextQState text) {

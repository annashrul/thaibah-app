...
export 'themeQ.dart' show Brightness, ThemeData;
...
class ThemeQ extends StatelessWidget {
...
class _InheritedTheme extends InheritedTheme {
  ...
  Widget wrap(BuildContext context, Widget child) {
    ...
    return identical(this, ancestorTheme) ? child : ThemeQ(data: theme.data, child: child);
  }

...
class LoadMoreQ extends StatefulWidget {
  ...
  @override
  _LoadMoreQState createState() => _LoadMoreQState();
}

class _LoadMoreQState extends State<LoadMoreQ> {
  Widget get child => widget.child;

  LoadMoreDelegate get loadMoreDelegate =>
      widget.delegate ?? LoadMoreQ.buildDelegate();
    ...
    return NotificationListener<_RetryNotify>(
      child: NotificationListener<_BuildNotify>(
        child: DefaultLoadMoreView(
          ...
          textBuilder: widget.textBuilder ?? LoadMoreQ.buildTextBuilder(),
        ),
          ...
          children: <Widget>[
            SizedBox(
              ...
              child: CircularProgressIndicator(
                backgroundColor: Color(0xFF30cc23),
              ),
            ),
            Padding(

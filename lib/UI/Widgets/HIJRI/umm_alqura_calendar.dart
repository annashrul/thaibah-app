...
import 'package:thaibah/UI/Widgets/HIJRI/umm_alqura_array.dart';

class ummAlquraCalendarQ {
  ...
  ummAlquraCalendarQ.fromDate(DateTime date) {
    gregorianToHijri(date.year, date.month, date.day);
  }

  ummAlquraCalendarQ.now() {
    this._now();
  }
  ummAlquraCalendarQ.addMonth(int year, int month) {

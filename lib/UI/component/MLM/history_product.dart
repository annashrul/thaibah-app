...
class _HistoryProductState extends State<HistoryProduct> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      key: scaffoldKey,
      appBar: UserRepository().appBarWithButton(context, "Riwayat Pembelian Produk", (){Navigator.of(context).pop();},<Widget>[]),
      body: Column(
        children: <Widget>[
          Padding(
                              ...
                              child: Column(
                                children: <Widget>[
                                  Row(
                                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                    children: <Widget>[
                                      RichText(text: TextSpan(text:kdTrx, style: TextStyle(fontSize: 12.0,fontFamily:ThaibahFont().fontQ,fontWeight: FontWeight.bold,color:Colors.black))),
                                  ...
                                  Row(
                                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                    children: <Widget>[
                                      RichText(text: TextSpan(text:"${DateFormat.yMMMMEEEEd('id').add_jm().format(snapshot.data.result.data[index].createdAt.toLocal())}", style: TextStyle(color: Colors.grey, fontSize: 12.0,fontFamily:ThaibahFont().fontQ,fontWeight: FontWeight.bold))),
                                      RichText(text: TextSpan(text:snapshot.data.result.data[index].price.toString(), style: TextStyle(color: Colors.grey, fontSize: 12.0,fontFamily:ThaibahFont().fontQ,fontWeight: FontWeight.bold))),
                                    ],
                                  ),
                                ],
                              ),

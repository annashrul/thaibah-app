...
class HistoryPlatinum extends StatefulWidget {
  @override
  _HistoryPlatinumState createState() => _HistoryPlatinumState();
}

class _HistoryPlatinumState extends State<HistoryPlatinum> {
